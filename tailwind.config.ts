	...
	theme: {
		...
		extend: {
			colors: {
				...
				'architect-gold': 'hsl(var(--architect-gold))',
				'architect-charcoal': 'hsl(var(--architect-charcoal))',
				'architect-stone': 'hsl(var(--architect-stone))',
				'architect-concrete': 'hsl(var(--architect-concrete))',
				sidebar: {
